...
=========================================================================*/
// .NAME vtkMyMinimalStandardRandomSequence - Park and Miller Sequence of pseudo
// random numbers .SECTION Description vtkMyMinimalStandardRandomSequence is a
// sequence of statistically independent pseudo random numbers uniformly
...
private:
    vtkMyMinimalStandardRandomSequence(
        const vtkMyMinimalStandardRandomSequence&);  // Not implemented.
    void operator=(
        const vtkMyMinimalStandardRandomSequence&);  // Not implemented.
};
