...
=========================================================================*/
// .NAME vtkVolumeProperties - estimate volume, area, shape index of triangle
// mesh .SECTION Description vtkVolumeProperties estimates the volume, the
// surface area, and the normalized shape index of a model.  The algorithm
// implemented here is based on the discrete form of the divergence theorem. The
// general assumption here is that the model is of closed surface.  For more
