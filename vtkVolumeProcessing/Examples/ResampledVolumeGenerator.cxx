...
void ResampledVolumeGenerator::SetDivisionFactors(
    int divisionFactorX, int divisionFactorY, int divisionFactorZ)
{
...
void ResampledVolumeGenerator::SetResamplingFactors(
    double resamplingFactorX,
    double resamplingFactorY,
    double resamplingFactorZ)
{
    ...
    for (int z = 0; z < _divisionFactorZ; z++) {
        for (int x = 0; x < _divisionFactorX; x++) {
            for (int y = 0; y < _divisionFactorY; y++) {
                ...
                // ENCORE A FAIRE: Trouver une manière pour ne pas devoir créer
                // un nouveau resampler/image à chaque fois Voilà, quelqu'un
                // d'autre est en charge du sous-échantillonnage!
                ...
                // ENCORE A FAIRE: Comment faire pour utiliser la même instance
                ...
                // ENCORE A FAIRE: Il faut bien regarder où l'on est en train de
                // demander de la mémoire, ici et ailleurs. Effectivement, la
                // création constante des nouvelles classes fait péter le truc.
                // C'est normal, les images de Sébastien sont géantes. Du coup,
                // il faut faire gaffe.
                reader->Delete();
                resampler->Delete();
                sousVolume->Delete();
