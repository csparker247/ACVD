...
void vtkMHDFileWriter::SetHeaderSize(int size) { _headerSize = size; }
...
void vtkMHDFileWriter::SetElementSpacing(
...
void vtkMHDFileWriter::SetPosition(
...
void vtkMHDFileWriter::SetCenterOfRotation(
...
void vtkMHDFileWriter::WriteToFile()
{
    ...
    mhdFile << "DimSize = " << _dimensions[0] << " " << _dimensions[1] << " "
            << _dimensions[2] << "\n";
    mhdFile << "ElementType = " << _elementType << "\n";
    mhdFile << "HeaderSize = " << _headerSize << "\n";
    mhdFile << "ElementNumberOfChannels = " << _numberOfChannels << "\n";
    mhdFile << "ElementSpacing = " << _elementSpacing[0] << " "
            << _elementSpacing[1] << " " << _elementSpacing[2] << "\n";
    mhdFile << "Position = " << _position[0] << " " << _position[1] << " "
            << _position[2] << "\n";
    mhdFile << "Offset = " << _offset[0] << " " << _offset[1] << " "
            << _offset[2] << "\n";
    mhdFile << "CenterOfRotation = " << _centerOfRotation[0] << " "
            << _centerOfRotation[1] << " " << _centerOfRotation[2] << "\n";
